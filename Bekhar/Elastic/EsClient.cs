    ...
    internal class EsClient
    {
        ...
        public static ElasticClient GetInstance()
        {
            if (innerClient == null)
            {
                ...
                var settings = new ConnectionSettings(new Uri("https://elastic:1IeomFYO4yVyqzlrO95SpXFy@a8769f2176114de3ac5fb6371bd61b21.eu-central-1.aws.cloud.es.io:9243")).DefaultIndex("bekhar").DisableDirectStreaming();
